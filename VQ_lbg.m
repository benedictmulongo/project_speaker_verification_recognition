function [codebook,distortion]=VQ_lbg(training_seq, codebook_size,tolerance)
...
%	codebook_size = K = size of the codebook (rate=log2(codebook_size)/dimension).
...
% training_seq = #Coefs X #NumFrames 

dimension = size(training_seq,1);
if (nargin==3)
    tolerance=0.001;
end
